...
const UserFooter = () => {
  ...
  const socialLinks = [
    ...
    {
      name: "GitHub",
      url: "https://github.com/pushkarcdn",
      color: "#000000",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Facebook",
      url: "https://facebook.com/pushkarcdn",
      color: "#1877F2",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 text-sm mb-6 max-w-sm">
              Connect with professionals, showcase your skills, and find or
              offer services all in one platform. Your gateway to professional
              excellence.
            </p>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="text-gray-400 transition-colors duration-200 hover:text-[var(--hover-color)]"
        ...
        <div className="component-px py-4">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0 gap-2">
            <div className="text-sm text-gray-600">
              &copy; {currentYear} Prime Skills. All rights reserved.
            </div>
            <div className="flex items-center space-x-1 text-sm text-gray-600">
              <span>By</span>
              <Link
                to={"https://pushkar.live"}
                target="_blank"
              ...
              <span>|</span>
              <span>Software Engineer @ F1Soft Group.</span>
            </div>
          </div>
        </div>
      </div>
